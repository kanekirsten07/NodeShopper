                 ...
                 console.log('connecting to database');
                    ...
                    values:[purchaser]};
                 	...
                 	response.write('<tr><td>' + 'Name of Item' + '</td><td>' + 'Date Purchased '+ '</td><td>'+ 'Taxable?' + '</td><td>'+ 'Paid For' + '</td><td>'+ 'Purchaser Name' + '</td><td>'+ 'Shared?'+ '</td><td>'+ 'Price'+ '</td><td>' + 'Date Entered'+'</td></tr>');
                    	...
                    	response.write('<tr><td>' + result.rows[i].nameofitem + '</td><td>' + result.rows[i].datepurchased + '</td><td>'+ result.rows[i].taxable + '</td><td>'+ result.rows[i].paidfor + '</td><td>'+ result.rows[i].purchasername + '</td><td>'+ result.rows[i].shared+ '</td><td>' + result.rows[i].price + '</td><td>' + result.rows[i].dateentered + '</td><td><form id='+ result.rows[i].myid+ 'action="/edigroceries" method ="get"><input type="submit" value="Edit"/><form id='+ result.rows[i].myid+ 'action="/removegroceries" method ="get"><input type="submit" value="Remove"/></td></tr>');
                    	}
