...
console.log('connecting to database');
	...
	response.write('<tr><td>' + result.rows[i].nameofitem + '</td><td>' + result.rows[i].datepurchased + '</td><td>'+ result.rows.taxable + '</td><td>'+ result.rows.paidfor + '</td><td>'+ result.rows.purchasername + '</td><td>'+ result.rows.shared+ "</td></tr>");
	}
