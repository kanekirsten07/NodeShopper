                 ...
                 console.log('connecting to database');
                    ...
                    values:[purchaser]};
                 	...
                 	response.write('<tr><td>' + 'Name of Item' + '</td><td>' + 'Date Purchased '+ '</td><td>'+ 'Taxable?' + '</td><td>'+ 'Paid For' + '</td><td>'+ 'Purchaser Name' + '</td><td>'+ 'Shared?'+ '</td><td>'+ 'Price'+ '</td><td>' + 'Date Entered'+'</td></tr>');
                    	...
                    	response.write('<tr><td>' + result.rows[i].nameofitem + '</td><td>' + result.rows[i].datepurchased + '</td><td>'+ result.rows[i].taxable + '</td><td>'+ result.rows[i].paidfor + '</td><td>'+ result.rows[i].purchasername + '</td><td>'+ result.rows[i].shared+ '</td><td>' + result.rows[i].price + '</td><td>' + result.rows[i].dateentered + '</td><td><form id='+ result.rows[i].myid+ 'action="/edigroceries" method ="get"><input type="submit" value="Edit"/></form><form id='+ result.rows[i].myid+ 'action="/removegroceries" method ="get"><input type="submit" value="Remove"/></form></td></tr>');
                    	}
           ...
           } else if (viewday=== '-Day-'|| viewday ==="")
                       {
                                          ...
                                          console.log('connecting to database');
                                             ...
                                             selectMonthOnly = {
                                          	...
                                          	response.write('<tr><td>' + 'Name of Item' + '</td><td>' + 'Date Purchased '+ '</td><td>'+ 'Taxable?' + '</td><td>'+ 'Paid For' + '</td><td>'+ 'Purchaser Name' + '</td><td>'+ 'Shared?'+ '</td><td>'+ 'Price'+ '</td><td>' + 'Date Entered'+'</td></tr>');
                                            	for(var i =0; i<result.rows.length; i++) {
                                            	response.write('<tr><td>' + result.rows[i].nameofitem + '</td><td>' + result.rows[i].datepurchased + '</td><td>'+ result.rows[i].taxable + '</td><td>'+ result.rows[i].paidfor + '</td><td>'+ result.rows[i].purchasername + '</td><td>'+ result.rows[i].shared+ '</td><td>' + result.rows[i].price + '</td><td>' + result.rows[i].dateentered + '</td><form id='+ result.rows[i].myid+ 'action="/edigroceries" method ="get"><input type="submit" value="Edit"/></form><form id='+ result.rows[i].myid+ 'action="/removegroceries" method ="get"><input type="submit" value="Remove"/></form></tr>');
                                            	}
                                          	response.write('</table>');
                                          	response.write('<p>Input either a standalone month, purchaser, a combination of month/purchaser, month/day or all three to filter your results</p>')
                                          	response.write('<form name="viewoptions" onsubmit = "return deletediv();" action="/viewgroceries" method="POST">');
