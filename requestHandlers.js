           ...
           if (viewday=== '-Day-')
                       {
                                          ...
                                          console.log('connecting to database');
                                             ...
                                             selectMonthOnly = {
                                          	...
                                          	response.write('Day: <select id="day"name ="day"> <option value=""> -Day-</option> <option value="1"> 1</option> <option value="2"> 2</option><option value="3"> 3</option> <option value="4"> 4</option> <option value="5"> 5</option><option value="6"> 6</option> <option value="7"> 7</option><option value="8">8</option>');
